...
calculateOffsetBtn.addEventListener("click", () => {
    ...
    if (offsetMode.value === "solveAngle") {
        ...
        if (clrMultiplier.value === "auto") {
            ...
            /*
             * The largest CLR that fits the requested
             * offset and overall length occurs when the
             * straight section between the elbows is zero.
             */
            ...
            /*
             * Auto prefers a full 1.00× CLR, but it may
             * reduce it when the requested geometry does
             * not have enough room. Auto is never allowed
             * to go below 0.75× CLR.
             */
            ...
            if (
                ...
                offsetResults.innerHTML = `
                    <p class="error">
                        That offset and overall length do not
                        have enough room for Auto CLR's minimum
                        0.75× radius. Increase the overall
                        length, reduce the cheek width, or
                        reduce the offset.
                    </p>
                `;
            ...
            if (!Number.isFinite(elbowAngle)) {
                ...
                offsetResults.innerHTML = `
                    <p class="error">
                        ...
                        elbow for those dimensions. Increase
